...
<body>
  ...
  <div class="topnav" id="myTopnav" >
    <img class="careerup-logo" src="careerup-logo.png" onclick=" location.href='index-careerup.html' ">
        <a href="#myPopularJobCategories" id="topnav-1">Categories</a>
        <a href="#myCities">Cities</a>
        <a href="#myFooter">About Us</a>
        <a href="#"><i class="fa fa-bell"></i></a>
        <a href="logout.php">
          <button type="button" class="button btn-login"><div class="login-text">Logout</div></button>
        </a>
      ...
      <div>
        <figure>
          <img src="categories6.jpg">
            <figcaption >Food Service</figcaption>  
          </figure>
      </div>
    </a>
  ...
  <div class="categories-btn-center">
          <button class="button categories-button" onclick=" location.href='categories-page.php' ">
   ...
   <div class="how-it-work" id="myHowItWork">
  ...
  <div class="cities" id="myCities">
    ...
    <div class="cities-flex">
      ...
      <div >
        <figure>
          <a href="#"><img src="delhi_ncr.svg" alt="Delhi" ></a>
      ...
      <div>
        <figure>
          <a href="#"><img src="bangalore.svg" alt="Bangalore" ></a>
      ...
      <div>
        <figure>
          <a href="cities-page.php"><img src="mumbai.svg" alt="Mumabi" ></a>
      ...
      <div>
        <figure>
          <a href="#"><img src="hyderabad.svg" alt="Hyderabad" ></a>
     ...
     <div class="cities-flex">
      ...
      <div >
        <figure>
          <a href="#"><img src="chennai.svg" alt="CHennai" ></a>
      ...
      <div>
        <figure>
          <a href="#"><img src="kolkata.svg" alt="Kolkata" ></a>
      ...
      <div>
        <figure>
          <a href="#"><img src="work_from_home.svg" alt="Work From Home" ></a>
          <figcaption>Work From Home</figcaption>
        </figure>
      </div>

      <div>
        <figure>
          <a href="#"><img src="international.svg" alt="International" ></a>
