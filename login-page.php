...
<?php
    ...
    session_start();
    if(isset($_POST['submit_login'])&&!isset($_POST['submit_Register']))
    { //trial code 
...
<?php
    ...
    require_once "config.php";
    $username = $password = $confirm_password = ""; // initailizing variable
    $username_err = $password_err = $confirm_password_err = ""; // initailizing variable for errors
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST')
        {
            ...
            if(empty(trim($_POST["username"]))){
                ...
                $sql = "SELECT id FROM users WHERE username = ?";  // Preparing the select statement and then bind the query
                $stmt = mysqli_prepare($conn,$sql); 
                if($stmt)
                {
                    mysqli_stmt_bind_param($stmt,"s",$param_username); // binding the prepare query

                    // Set the value of param username
                    $param_username = trim($_POST['username']); // removers the whitespaces
        ...
        elseif(strlen(trim($_POST['password'])) <5){
            $password_err = "Password cannot be less then 5 charactres";
        ...
        if(trim($_POST['password']) != trim($_POST['confirm_password'])){
            $password_err = "Password should matchk";
        }


        // if there are no errors then enter into the Database
...
<div class="login-bar">
    ...
    <ol>
      ...
      <li id="li2">
        <i class="fa fa-caret-right" style="padding: 0px 8px;"></i><span> Login/Register </span>
      </li>
    </ol>
  </div>
      ...
      <div class="login-card" >
         ...
         <h3> Login Your Account </h3>
          <form action="" method="POST">
                  <input type="email" placeholder="UserName or email" id="fname" name="username"><br><br>
                  <input type="password" placeholder="Password" id="password" name="password"><br><br>
                  <a class="lost-password" href="">Lost Your Password?</a><br><br>
                  <input class="login-button" type="submit" id="submit" value="Login" name="submit_login"><br>
          </form>
            ...
            <div class="inner-social">
              ...
              <div class="linkedin-login-btn-wrapper">
               ...
               <div class="twitter-login-btn-wrapper">
                <a class="twitter-login-btn" href="#">
      ...
      <div class="login-card2" >
         ...
         <h3> Choose Your Account Type </h3>
          <form action="" method="POST">
            ...
            <ul class="role-tabs">
              <li class="active">
                <input id="cadidate" type="radio" name="role" value="wp_job_board_candidate" checked="checked" onclick="javascript:yesnoCheck();">
                <label for="cadidate">Candidate</label>
              </li>

              <li class>
                <input type="radio" id="employer" name="role" value="wp_job_board_employer" onclick="javascript:yesnoCheck();">
                <label for="employer">Employer</label>
              </li>
            </ul>
                  <!-- <input type="text" placeholder="Username *" id="fname" name="Username" required><br><br> -->
          
                  <input type="email" placeholder="Email *" id="register-email" name="username" required><br><br>
                  ...
                  <div id="myCname" style="display: none;">
                    <input type="company-name" placeholder="Company Name *" name="com-name" id="c-name">
                  </div>
                  <input type="tel" placeholder="Phone *" id="register-phoneno" name="phoneno" pattern="[0-9]{10}" required><br><br> 
                  ...
                  <!-- <input class="login-button" type="submit" id="submit" value="Login"><br> -->

                  <div class="form-group">
                    <button type="submit" class="btn btn-block" name="submit_Register">
                      Register now          
                    </button>
                  </div>
          </form>
